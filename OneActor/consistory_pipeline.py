...
class ConsistoryExtendAttnSDXLPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if share_queries and (i >= query_store.t_range[0] and i <= query_store.t_range[1]):
                    ...
                    noise_pred_vanilla, mid_save = self.unet(
                        latent_model_input,
                        t,
                    ...
                    mid_save_vanilla_list.append(mid_save)

                    query_store.set_mode('inject')
                else:
                    mid_save_vanilla_list.append(None)                
                ...
                xt_save.append(latents) # oneactor
        ...
        if not return_dict:
            return image, prompt_embeds, xt_save, mid_save_list, mid_save_vanilla_list

        return StableDiffusionXLPipelineOutput(images=image), prompt_embeds, xt_save, mid_save_list, mid_save_vanilla_list